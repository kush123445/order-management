        ...
        <div>
            {isSticky && (
              <div  style={{ 
                ...
                width: '100%', height: '120px',  position: 'fixed', top: 0, zIndex: 1000 ,background:'#fdfdfd',paddingTop:'5px'}}>
...
{/* </div> */}
      ...
      <div style={{ overflowX: 'auto', whiteSpace: 'nowrap',paddingLeft:"10px", backgroundColor: '', zIndex: '1' ,marginTop:'-10px',marginBottom:'2px', scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch'}}>
      {data.map((item, index) => (
